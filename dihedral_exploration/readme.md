...
- The other folders *model_number* include only the input files and the result for the radius of gyration. 

In all cases, we perform an initial equilibration phase and a subsequent production run. The radius of gyration is calculated over the production run.
