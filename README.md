...
The simulations correspond to a simple charged beads connected by springs (including dihedrals) in implicit solvent with electrostatics modelled at the Debye approximation level.
